...
@NgModule({ imports: [HttpClientModule],
  	declarations: [],
  	providers: [HttpInventoryService, { provide: GETS_ALL_INVENTORY_DTO, useExisting: HttpInventoryService }, { provide: ADDS_INVENTORY_DTO, useExisting: HttpInventoryService }, { provide: REMOVES_INVENTORY_DTO, useExisting: HttpInventoryService }],
  	exports: [] })
